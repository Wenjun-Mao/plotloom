...
| H3, security, platform, acceptance-tool relocation, old pipeline retirement | **Out of this track.** H3's current bounded experiment is owned by the [playable MVP tracker](2026-09-17-playable-mvp-milestones.md); it does not turn H3 into simplification work. Keep other owners and gates; the source reports do not authorize bundling them here. |
