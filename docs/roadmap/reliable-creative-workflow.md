...
| 4 | Partial — two identity-reviewed stills and two explicit-crop H3 candidates ingested; both pilot allowances exhausted | [Readiness preflight](../verification/2026-09-15-step-4-two-shot-pilot.md); [bounded pilot attempt](../verification/2026-09-15-step-4-two-shot-pilot-attempt.md); [repair-boundary verification](../verification/2026-09-15-step-4-exact-repair-boundary.md); [live continuation receipt](../verification/2026-09-15-step-4-exact-repair-live-continuation.md); [continuity-state diagnosis](../verification/2026-09-15-step-4-continuity-state-diagnosis.md); [offline authority repair receipt](../verification/2026-09-15-step-4-continuity-authority-repair.md); [fresh current-contract pilot](../verification/2026-09-15-step-4-fresh-current-contract-pilot.md); [bytecode-boundary repair](../verification/2026-09-15-step-4-pin-bytecode-boundary.md); [media continuation](../verification/2026-09-15-step-4-media-continuation.md); ADR 0037 | The retained original and incompatible adaptation remain preserved. The approved first crop and the reviewed non-material second near-9:16 crop were each frozen as `cover_center_crop` against original reviewed bytes; no local derivative or extra sizing attempt was made. Both five-second native-audio H3 candidates were submitted exactly once and ingested. Native Chrome now plays their retained, hash-valid bytes to completion; the earlier crash is confined to the in-app renderer. Audio cannot be observed by this agent, so both candidates remain unselected and no human/product acceptance, sequential playback, close/reopen, snapshot, or isolated restore is claimed. | Use a genuinely audio-observable review surface to review both retained candidates before selecting either; do not generate, dispatch, or re-audit without new authority. |
