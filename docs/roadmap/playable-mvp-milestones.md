...
| F6 — Audiovisual qualification **([readiness receipt](../verification/2026-09-18-f6-h3-audiovisual-readiness.md), [offline 5/8-second contract receipt](../verification/2026-09-18-f6-h3-eight-second-offline-contract.md), [first live non-qualifying receipt](../verification/2026-09-18-f6-h3-first-clip-live-receipt.md), and [offline corrective prompt proof](../verification/2026-09-18-f6-dialogue-prompt-offline-proof.md); not audiovisual or production acceptance)** | Test native H3 dialogue, speaker attribution, cross-clip voice consistency and prompt effectiveness | Plotloom admits explicit 5- and 8-second H3 I2V contracts. The single F6 live 8-second clip objectively ingested as 192 frames / 24 fps / H.264/AAC but is unselected and non-qualifying: its test-only fixture froze a generic shot prompt instead of the required Mandarin line and room-tone/no-music direction. The offline corrective fixture proves the normal frozen compiler receives the exact line, C01/Lin Che speaker, room-tone/no-narration/no-music event, 8-second/192-frame/24-fps request, reviewed aspect policy, and profile; the retained generic snapshot fails that same pre-submit assertion. This does not qualify audio or authorize a second clip/retry. | No speculative TTS/lip-sync stack; no pad/trim/stitch workaround, duplicate queue, F5-to-media compiler, or retry under this assignment. Keep F5/F7 production-reference and mapping choices explicit. |
