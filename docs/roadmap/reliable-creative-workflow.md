...
| 4 | Partial — two identity-reviewed stills and two explicit-crop H3 candidates selected from attributed human audiovisual feedback; both pilot allowances exhausted | [Readiness preflight](../verification/2026-09-15-step-4-two-shot-pilot.md); [bounded pilot attempt](../verification/2026-09-15-step-4-two-shot-pilot-attempt.md); [repair-boundary verification](../verification/2026-09-15-step-4-exact-repair-boundary.md); [live continuation receipt](../verification/2026-09-15-step-4-exact-repair-live-continuation.md); [continuity-state diagnosis](../verification/2026-09-15-step-4-continuity-state-diagnosis.md); [offline authority repair receipt](../verification/2026-09-15-step-4-continuity-authority-repair.md); [fresh current-contract pilot](../verification/2026-09-15-step-4-fresh-current-contract-pilot.md); [bytecode-boundary repair](../verification/2026-09-15-step-4-pin-bytecode-boundary.md); [media continuation](../verification/2026-09-15-step-4-media-continuation.md); [reviewed recovery continuation](../verification/2026-09-15-step-4-reviewed-recovery-blocker.md); ADR 0037 | Both native-audio H3 candidates remain hash-valid and were selected through normal review records from the user's exact audiovisual feedback. Their frozen shots have no dialogue cues and ambience-only audio, so the reported lack of dialogue is contract-compatible; it is not a Codex-hearing, lip-sync, general dialogue, human/product, or Alpha claim. Chrome can play an individual selected clip, but the selected-player sequence is scene-scoped and these adjacent candidates are in different scenes, so no cross-scene transition/final-hold proof exists. Safe close and snapshot each refuse with `project_busy: image_publication_active` because the preserved incompatible-adaptation image job remains exported; no restore was attempted. | Approve a cross-scene selected-playback ordering contract and resolve the existing image-publication recovery blocker before another bounded proof; do not generate, dispatch, cancel, clean up, or re-audit without new authority. |
