...
| 4 | Partial — identity reference and first reviewed still completed; exact H3-profile adaptation blocked | [Readiness preflight](../verification/2026-09-15-step-4-two-shot-pilot.md); [bounded pilot attempt](../verification/2026-09-15-step-4-two-shot-pilot-attempt.md); [repair-boundary verification](../verification/2026-09-15-step-4-exact-repair-boundary.md); [live continuation receipt](../verification/2026-09-15-step-4-exact-repair-live-continuation.md); [continuity-state diagnosis](../verification/2026-09-15-step-4-continuity-state-diagnosis.md); [offline authority repair receipt](../verification/2026-09-15-step-4-continuity-authority-repair.md); [fresh current-contract pilot](../verification/2026-09-15-step-4-fresh-current-contract-pilot.md); [bytecode-boundary repair](../verification/2026-09-15-step-4-pin-bytecode-boundary.md); [media continuation](../verification/2026-09-15-step-4-media-continuation.md); ADR 0015 and ADR 0022 | The retained project is current, its completed identity delivery has exact private-staging cleanup and was selected through the normal author workflow. One identity-consistent opening still was delivered, reviewed, retained, and selected. Its 941×1672 bytes correctly failed the frozen H3 Portrait Fast 576×1024 ratio gate. The dedicated ImageGen keyframe-adaptation package also returned 941×1672 despite its exact output contract; its unaccepted staged output is preserved. No crop, padding, H3 dispatch, audiovisual review, or human/product acceptance was claimed. | Preserve the incompatible adaptation output and package evidence. Reassess the provider's exact-geometry capability before a separately authorized new image attempt; do not replay the mismatched delivery or dispatch H3 from it. |
