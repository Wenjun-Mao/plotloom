...
| 4 | Partial — fresh current-contract generation and storyboard approval complete; media preflight blocked | [Readiness preflight](../verification/2026-09-15-step-4-two-shot-pilot.md); [bounded pilot attempt](../verification/2026-09-15-step-4-two-shot-pilot-attempt.md); [repair-boundary verification](../verification/2026-09-15-step-4-exact-repair-boundary.md); [live continuation receipt](../verification/2026-09-15-step-4-exact-repair-live-continuation.md); [continuity-state diagnosis](../verification/2026-09-15-step-4-continuity-state-diagnosis.md); [offline authority repair receipt](../verification/2026-09-15-step-4-continuity-authority-repair.md); [fresh current-contract pilot](../verification/2026-09-15-step-4-fresh-current-contract-pilot.md); [bytecode-boundary repair](../verification/2026-09-15-step-4-pin-bytecode-boundary.md); ADR 0015 and ADR 0022 | The old parent/child remains preserved. A fresh project installed the full four-stage graph, including typed graph effects and the previously failing Scene Beats #7, then recorded a Codex-attributed (not human) storyboard approval. The first identity-reference package preflight refused because its pinned specialist source was not committed at `HEAD`; no ImageGen or H3 call occurred. The later source-boundary repair accepts normal runtime bytecode while preserving fail-closed source checks; it does not replay the package. | Preserve the new project and exported package. A separately authorized continuation must resolve the pin authority before re-attempting that exact package; do not retry, switch model, or claim Step 4 complete. |
