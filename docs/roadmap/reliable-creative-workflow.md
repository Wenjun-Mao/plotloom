...
| 4 | Implementation candidate — selected-route preview, terminal cancelled-publication disposition, and lean repair/API removal are awaiting the required full gates and independent review | [Readiness preflight](../verification/2026-09-15-step-4-two-shot-pilot.md); [bounded pilot attempt](../verification/2026-09-15-step-4-two-shot-pilot-attempt.md); [reviewed recovery continuation](../verification/2026-09-15-step-4-reviewed-recovery-blocker.md); ADR 0037; ADR 0051 | The retained H3 candidates and image-job row remain untouched by this source-only slice. The preview now requires an explicit valid route and honestly reports missing selected clips; cancelled publication is terminal for close/snapshot while late delivery remains inapplicable. | Run the recorded source gates and attended independent review; the director may then separately perform the single authorized cancellation and recovery proof. |
