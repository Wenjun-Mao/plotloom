...
SUPPORTED_SKILL_VERSION = "plotloom-image-specialist.v2"
SKILL_PATH = Path(".agents/skills/plotloom-image-specialist/SKILL.md")
PINNED_SOURCES = (SKILL_PATH, Path("scripts/pin_image_specialist.py"), Path("src/plotloom/image_job_exchange.py"), Path("src/plotloom/image_job_contracts.py"), Path("src/plotloom/persistence.py"))
