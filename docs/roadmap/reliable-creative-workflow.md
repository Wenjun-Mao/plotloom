...
| 2 | Incomplete | [Coverage summary](../verification/2026-09-14-retained-runtime-coverage-summary.md); accepted three-scenario slice `01874da` | Unresolved semantic mappings and H3 V4 coverage reconciliation | Close current contracts in bounded groups; keep pending explicit |
