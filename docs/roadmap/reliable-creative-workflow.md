...
| 4 | Partial — identity reference and first reviewed still completed; explicit reviewed H3 gateway crop is available for the approved pilot | [Readiness preflight](../verification/2026-09-15-step-4-two-shot-pilot.md); [bounded pilot attempt](../verification/2026-09-15-step-4-two-shot-pilot-attempt.md); [repair-boundary verification](../verification/2026-09-15-step-4-exact-repair-boundary.md); [live continuation receipt](../verification/2026-09-15-step-4-exact-repair-live-continuation.md); [continuity-state diagnosis](../verification/2026-09-15-step-4-continuity-state-diagnosis.md); [offline authority repair receipt](../verification/2026-09-15-step-4-continuity-authority-repair.md); [fresh current-contract pilot](../verification/2026-09-15-step-4-fresh-current-contract-pilot.md); [bytecode-boundary repair](../verification/2026-09-15-step-4-pin-bytecode-boundary.md); [media continuation](../verification/2026-09-15-step-4-media-continuation.md); ADR 0037 | The retained project is current, its completed identity delivery has exact private-staging cleanup and was selected through the normal author workflow. One identity-consistent opening still was delivered, reviewed, retained, and selected. Its 941×1672 original bytes remain intact, as does the unaccepted same-sized ImageGen adaptation. The user-approved Step 4 amendment permits only an explicit, frozen `cover_center_crop` gateway request; it preserves the original source identity/provenance and does not create a local derivative or another ImageGen sizing attempt. No crop dispatch, audiovisual review, or human/product acceptance is claimed by this offline implementation. | Resume the already-approved H3 pilot budget with the explicit gateway crop choice; preserve the retained original and unaccepted adaptation. |
