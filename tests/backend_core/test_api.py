...
def test_exact_v2_route_contract(repository: SQLiteRepository) -> None:
    ...
    assert actual == {
        ...
        ("GET", "/api/v2/projects/{project_id}/runs"),
            ...
            ("POST", "/api/v2/projects/{project_id}/video-jobs/{video_job_id}/reconcile"),
            ("POST", "/api/v2/projects/{project_id}/video-jobs/{video_job_id}/cancel"),
            ("POST", "/api/v2/projects/{project_id}/video-jobs/{video_job_id}/review"),
            ("GET", "/api/v2/projects/{project_id}/video-jobs/{video_job_id}/media"),
