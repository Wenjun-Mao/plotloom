...
| 5 | Not accepted — native branching browser proof failed | ADR 0026 native media-session gate; [receipt](../verification/2026-09-16-step-5-branching-preview.md) | The production FastAPI offline fixture serves decodable clips, but native player-session transitions do not yet satisfy the start/successor contract. Retained pilot footage is also incomplete. | Preserve the failing fixture/diagnostics; obtain a new bounded authorization before another lifecycle correction or creative-media work. |
