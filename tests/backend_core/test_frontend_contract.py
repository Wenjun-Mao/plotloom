...
def test_handwritten_response_dtos_match_openapi_fields_and_nullability() -> None:
    ...
    response_dtos = {
        ...
        "CharacterV2": "CharacterCard",
        "LocationV2": "LocationCard",
        "PropV2": "PropCard",
        "StoryBibleV2": "StoryBible",
        "StoryNodeV2": "StoryNode",
        "StoryEdgeV2": "StoryEdge",
        "JoinContractV2": "JoinContract",
        "StoryGraphV2": "StoryGraph",
        "ContinuityStateV2": "ContinuityState",
        "DramaticSceneV2": "DramaticScene",
        "BeatV2": "Beat",
        "SceneBeatPlanV2": "SceneBeatPlan",
        "DialogueCue": "DialogueCue",
        "RequiredEntityState": "RequiredEntityState",
        "AudioEvent": "AudioEvent",
        "AudioPlan": "AudioPlan",
        "ShotV2": "Shot",
        "ShotBeatLinkV2": "ShotBeatLink",
        ...
        "ApprovalDecisionView": "ApprovalDecision",
        "ApprovalClosureView": "ApprovalClosure",
        "StoryboardReviewResponse": "StoryboardReview",
        ...
        "Artifact": "RunArtifact",
            "RunTrace": "RunTrace",
            "GenerationPlanTrace": "GenerationPlanTrace",
            "StagePlanTrace": "StagePlanTrace",
            "GenerationWorkUnitTrace": "GenerationWorkUnitTrace",
            "SealedStageAggregateTrace": "SealedStageAggregateTrace",
            "RunExecutionTrace": "RunExecutionTrace",
