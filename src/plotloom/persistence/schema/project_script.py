"""F4 review rows.  Upstream JSON remains the creative authority."""
...
class ScriptHeadRow(Base):
    __tablename__ = "v2_script_heads"
...
class ScriptCandidateRow(Base):
    __tablename__ = "v2_script_candidates"
    ...
    expected_script_revision: Mapped[int] = mapped_column(Integer, nullable=False)
...
class ScriptRevisionRow(Base):
    __tablename__ = "v2_script_revisions"
