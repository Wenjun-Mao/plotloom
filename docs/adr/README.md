...
| Production playback timing (decision pending) | [0082, proposed](0082-proposed-production-playback-timing.md) distinguishes authored shot time, frozen request, measured take and a reviewed segment. It does not change the accepted H3 contract or authorize media work until adopted. |
